...
List<webdsl.generated.domain.SessionMessage> copy=new ArrayList<webdsl.generated.domain.SessionMessage>(col);
Iterator<webdsl.generated.domain.SessionMessage> it=copy.iterator();
while(it.hasNext()){
...
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SessionManager as g where g._logsqlMessage = :param4").setParameter("param4",prop_).list();
}
public static java.util.List<webdsl.generated.domain.SessionManager> _static_findByLogsqlMessageLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SessionManager as g where g._logsqlMessage like :param5").setParameter("param5",s_).list();
}
