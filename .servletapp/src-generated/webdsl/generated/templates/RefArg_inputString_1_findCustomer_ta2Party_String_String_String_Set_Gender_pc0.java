...
import webdsl.generated.domain.*;import utils.*;@SuppressWarnings("all")public class RefArg_inputString_1_findCustomer_ta2Party_String_String_String_Set_Gender_pc0 extends utils.RefArg{
public  webdsl.generated.domain.Party party_;
public RefArg_inputString_1_findCustomer_ta2Party_String_String_String_Set_Gender_pc0(){}
public RefArg_inputString_1_findCustomer_ta2Party_String_String_String_Set_Gender_pc0(Object party_){
this.party_=(webdsl.generated.domain.Party)party_;
}
public webdsl.generated.domain.Party set(Object obj){
party_.setSurname((String)org.webdsl.tools.Utils.cast(obj,String.class));
return party_;
}
public Object get(){
return (String)party_.getSurname();
}
...
return party_.getId()+"!"+"RefArg_inputString_1_findCustomer_ta2Party_String_String_String_Set_Gender_pc0";
}
...
party_.validateSurname_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Party").getPropertyByName("surname");
}
