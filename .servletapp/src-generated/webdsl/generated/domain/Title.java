...
import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_Title")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class Title implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static Title _static_createEmpty_(){
Title ent=new Title();
...
thepage.invalidateAllPageCache("Title");
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"Title");
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("Title")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?Title.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):Title.class.cast(o)).getId(),getId());
}
public Title save(String webdslTypeName){
setVersion(1);
...
return getId().compareTo(((Title)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("Title")||s.equals("Object")||s.equals("Entity");
}
...
public Title setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public Title setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public Title setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged();
...
return utils.HibernateUtil.getCurrentSession().createQuery("from Title").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from Title").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.Title> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from Title as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.Title> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from Title as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.Title _static_load_(java.util.UUID prop_){
return (webdsl.generated.domain.Title)org.webdsl.tools.Utils.cast(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"Title",prop_),webdsl.generated.domain.Title.class);
}
public webdsl.generated.domain.Title Title$this_(){
this.Title_();
return this;
}
public void Title_(){}
