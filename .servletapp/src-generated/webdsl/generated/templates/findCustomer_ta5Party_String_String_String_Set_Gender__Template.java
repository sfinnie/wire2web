...
import webdsl.generated.domain.*;import webdsl.generated.actions.*;@SuppressWarnings("all")public class findCustomer_ta5Party_String_String_String_Set_Gender__Template extends TemplateServlet{
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){}
public static void loadRefArgClasses(Map<String,Class<?>> refargclasses){
refargclasses.put("RefArg_inputString_1_findCustomer_ta5Party_String_String_String_Set_Gender_pc0",RefArg_inputString_1_findCustomer_ta5Party_String_String_String_Set_Gender_pc0.class);
}
...
staticEnv.putTemplate(keyOverwrite==null?"findCustomer_ta5Party_String_String_String_Set_Gender_":keyOverwrite,findCustomer_ta5Party_String_String_String_Set_Gender__Template.class);
...
return "findCustomer_ta5Party_String_String_String_Set_Gender_";
}
public String getStateEncodingOfArgument(){
return ""+("ref"+("ref"+("ref"+("ref"+"ref"))));
}
public String getTemplateSignature(){
return "template findCustomer_ta5(party : Ref<Party>, organisation : Ref<String>, postcode : Ref<String>, gender : Ref<String>, genderOpts : Ref<Set<Gender>>)";
}
