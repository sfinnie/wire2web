...
import webdsl.generated.domain.*;import webdsl.generated.actions.*;@SuppressWarnings("all")public class findCustomer_ta4Party_String_String_String_Set_Gender__Template extends TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"findCustomer_ta4Party_String_String_String_Set_Gender_":keyOverwrite,findCustomer_ta4Party_String_String_String_Set_Gender__Template.class);
...
return "findCustomer_ta4Party_String_String_String_Set_Gender_";
}
public String getStateEncodingOfArgument(){
return ""+("ref"+("ref"+("ref"+("ref"+"ref"))));
}
public String getTemplateSignature(){
return "template findCustomer_ta4(party : Ref<Party>, organisation : Ref<String>, postcode : Ref<String>, gender : Ref<String>, genderOpts : Ref<Set<Gender>>)";
}
...
handleTemplateCall(phase,inForLoop,forelementcounter,"tcall48","inputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{postcode_},"inputString"),new Environment(env).putWithcall("elements#inputString",new utils.TemplateCall("elementsempty",null,null,null)),"inputString",attrsmapout);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"inputString(postcode) at ../wire2web.app:74/25");
}
}
}
