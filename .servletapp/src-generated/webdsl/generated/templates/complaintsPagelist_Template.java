...
import webdsl.generated.domain.*;import webdsl.generated.actions.*;@SuppressWarnings("all")public class complaintsPagelist_Template extends TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"complaintsPagelist":keyOverwrite,complaintsPagelist_Template.class);
loadLiftedTemplateMap(staticEnv);
return staticEnv;
}
public String getUniqueName(){
return "complaintsPagelist";
}
public String getStateEncodingOfArgument(){
return "";
}
public String getTemplateSignature(){
return "template complaintsPagelist()";
}
...
if(RENDER_PHASE==phase){
try{
utils.RenderUtils.printPageString("Introduction",out,threadLocalPageCached.isRawoutput());
}
...
if(RENDER_PHASE==phase){
out.print("<a href=\"");
out.print(utils.HTMLFilter.filter(utils.Navigate.constructUrl("findCustomer")));
out.print("\"");
{
StringBuilder classattrs=new StringBuilder();
StringBuilder styleattrs=new StringBuilder();
...
if(RENDER_PHASE==phase){
out.print("<a href=\"");
out.print(utils.HTMLFilter.filter(utils.Navigate.constructUrl("submitComplaint")));
out.print("\"");
{
StringBuilder classattrs=new StringBuilder();
StringBuilder styleattrs=new StringBuilder();
...
if(RENDER_PHASE==phase){
try{
utils.RenderUtils.printPageString("Submit Complaint",out,threadLocalPageCached.isRawoutput());
}
catch(NullPointerException npe){
utils.Warning.warn("null reference prevented rendering of template element");
}
...
if(RENDER_PHASE==phase){
out.print("<a href=\"");
out.print(utils.HTMLFilter.filter(utils.Navigate.constructUrl("confirmation")));
out.print("\"");
{
StringBuilder classattrs=new StringBuilder();
StringBuilder styleattrs=new StringBuilder();
...
if(RENDER_PHASE==phase){
try{
utils.RenderUtils.printPageString("Confirmation",out,threadLocalPageCached.isRawoutput());
}
catch(NullPointerException npe){
utils.Warning.warn("null reference prevented rendering of template element");
}
