...
return utils.HibernateUtil.getCurrentSession().createQuery("select g from dummy_webdsl_entity as g where g._text = :param6").setParameter("param6",prop_).list();
}
public static java.util.List<webdsl.generated.domain.dummy_webdsl_entity> _static_findByTextLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from dummy_webdsl_entity as g where g._text like :param7").setParameter("param7",s_).list();
}
