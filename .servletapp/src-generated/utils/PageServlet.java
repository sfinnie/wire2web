...
import webdsl.generated.templates.*;import webdsl.generated.domain.*;import org.webdsl.WebDSLEntity;
...
static {
try{
addBodyAttributeString_String_Template.loadTemplateMap(staticEnv);
addBodyAttributeString_String_Template.loadRefArgClasses(refargclasses);
...
br_Template.loadTemplateMap(staticEnv);
br_Template.loadRefArgClasses(refargclasses);
break_Template.loadTemplateMap(staticEnv);
break_Template.loadRefArgClasses(refargclasses);
code_Template.loadTemplateMap(staticEnv);
code_Template.loadRefArgClasses(refargclasses);
column_Template.loadTemplateMap(staticEnv);
column_Template.loadRefArgClasses(refargclasses);
complaintsPagelist_Template.loadTemplateMap(staticEnv);
complaintsPagelist_Template.loadRefArgClasses(refargclasses);
...
emph_Template.loadTemplateMap(staticEnv);
emph_Template.loadRefArgClasses(refargclasses);
...
h1_Template.loadTemplateMap(staticEnv);
h1_Template.loadRefArgClasses(refargclasses);
h2_Template.loadTemplateMap(staticEnv);
h2_Template.loadRefArgClasses(refargclasses);
h3_Template.loadTemplateMap(staticEnv);
h3_Template.loadRefArgClasses(refargclasses);
h4_Template.loadTemplateMap(staticEnv);
h4_Template.loadRefArgClasses(refargclasses);
h5_Template.loadTemplateMap(staticEnv);
h5_Template.loadRefArgClasses(refargclasses);
h6_Template.loadTemplateMap(staticEnv);
h6_Template.loadRefArgClasses(refargclasses);
head_Template.loadTemplateMap(staticEnv);
head_Template.loadRefArgClasses(refargclasses);
...
pagelist_Template.loadTemplateMap(staticEnv);
pagelist_Template.loadRefArgClasses(refargclasses);
pagelist_Template.loadTemplateMap(staticEnv);
pagelist_Template.loadRefArgClasses(refargclasses);
pagenotes_Template.loadTemplateMap(staticEnv);
pagenotes_Template.loadRefArgClasses(refargclasses);
par_Template.loadTemplateMap(staticEnv);
par_Template.loadRefArgClasses(refargclasses);
postProcessString_Template.loadTemplateMap(staticEnv);
postProcessString_Template.loadRefArgClasses(refargclasses);
...
strong_Template.loadTemplateMap(staticEnv);
strong_Template.loadRefArgClasses(refargclasses);
...
wfPageTemplate_Template.loadTemplateMap(staticEnv);
wfPageTemplate_Template.loadRefArgClasses(refargclasses);
wireframe_Template.loadTemplateMap(staticEnv);
wireframe_Template.loadRefArgClasses(refargclasses);
wireframe_Template.loadTemplateMap(staticEnv);
wireframe_Template.loadRefArgClasses(refargclasses);
...
confirmation_Template.loadTemplateMap(staticEnv);
confirmation_Template.loadRefArgClasses(refargclasses);
findCustomer_Template.loadTemplateMap(staticEnv);
findCustomer_Template.loadRefArgClasses(refargclasses);
...
submitComplaint_Template.loadTemplateMap(staticEnv);
submitComplaint_Template.loadRefArgClasses(refargclasses);
}
catch(Exception se){
...
return ThreadLocalServlet.get().isPostRequest&&parammap.get("post-request-no-action")==null||parammap.get("action-call-with-get-request-type")!=null;
}
