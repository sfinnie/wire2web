...
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._name = :param22").setParameter("param22",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._name like :param23").setParameter("param23",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRequestedURL_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._requestedURL = :param24").setParameter("param24",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRequestedURLLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._requestedURL like :param25").setParameter("param25",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByClientIP_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._clientIP = :param26").setParameter("param26",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByClientIPLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._clientIP like :param27").setParameter("param27",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByMethod_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._method = :param28").setParameter("param28",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByMethodLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._method like :param29").setParameter("param29",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByReferer_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._referer = :param30").setParameter("param30",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRefererLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._referer like :param31").setParameter("param31",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByUserAgent_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._userAgent = :param32").setParameter("param32",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByUserAgentLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._userAgent like :param33").setParameter("param33",s_).list();
}
