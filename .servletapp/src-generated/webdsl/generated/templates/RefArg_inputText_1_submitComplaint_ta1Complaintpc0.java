...
import webdsl.generated.domain.*;import utils.*;@SuppressWarnings("all")public class RefArg_inputText_1_submitComplaint_ta1Complaintpc0 extends utils.RefArg{
public  webdsl.generated.domain.Complaint complaint_;
public RefArg_inputText_1_submitComplaint_ta1Complaintpc0(){}
public RefArg_inputText_1_submitComplaint_ta1Complaintpc0(Object complaint_){
this.complaint_=(webdsl.generated.domain.Complaint)complaint_;
}
public webdsl.generated.domain.Complaint set(Object obj){
complaint_.setDetails((String)org.webdsl.tools.Utils.cast(obj,String.class));
return complaint_;
}
public Object get(){
return (String)complaint_.getDetails();
}
...
return complaint_.getId()+"!"+"RefArg_inputText_1_submitComplaint_ta1Complaintpc0";
}
...
complaint_.validateDetails_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Complaint").getPropertyByName("details");
}
