...
import webdsl.generated.domain.*;import utils.*;@SuppressWarnings("all")public class RefArg_inputString_1_findCustomer_ta1Party_String_String_String_Set_Gender_pc0 extends utils.RefArg{
public  webdsl.generated.domain.Party party_;
public RefArg_inputString_1_findCustomer_ta1Party_String_String_String_Set_Gender_pc0(){}
public RefArg_inputString_1_findCustomer_ta1Party_String_String_String_Set_Gender_pc0(Object party_){
this.party_=(webdsl.generated.domain.Party)party_;
}
public webdsl.generated.domain.Party set(Object obj){
party_.setForename((String)org.webdsl.tools.Utils.cast(obj,String.class));
return party_;
}
public Object get(){
return (String)party_.getForename();
}
...
return party_.getId()+"!"+"RefArg_inputString_1_findCustomer_ta1Party_String_String_String_Set_Gender_pc0";
}
...
party_.validateForename_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Party").getPropertyByName("forename");
}
